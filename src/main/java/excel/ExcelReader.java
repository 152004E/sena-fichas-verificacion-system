...
public class ExcelReader {
    ...
    public List<Ficha> leerFichasDesdeExcel(File archivo) throws Exception {
        ...
        try (FileInputStream fis = new FileInputStream(archivo);
            ...
            if (sheet == null) throw new Exception("No se encontró la Hoja7 en el Excel");
            ...
            for (int i = 2; i <= sheet.getLastRowNum(); i++) {
                ...
                if (numFichaStr == null || numFichaStr.isEmpty() || numFichaStr.equals("FICHA")) continue;
