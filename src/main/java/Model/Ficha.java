...
public class Ficha {
    ...
    public String getInstructorTecnico2025() {
        return instructorTecnico2025;
    }

    public String getInstructorBilinguismo() {
        return instructorBilinguismo;
    }

    public String getInstructorTecnico2026() {
        return instructorTecnico2026;
    }

    public String getTransversalesFaltantes() {
        return transversalesFaltantes;
    }
    ...
    public void setFechaFinLec(String fechaFinLec) {
        this.fechaFinLec = fechaFinLec;
    }
    ...
    public void setInstructorTecnico2025(String v) {
        this.instructorTecnico2025 = v;
    }

    public void setInstructorBilinguismo(String v) {
        this.instructorBilinguismo = v;
    }

    public void setInstructorTecnico2026(String v) {
        this.instructorTecnico2026 = v;
    }

    public void setTransversalesFaltantes(String v) {
        this.transversalesFaltantes = v;
    }
